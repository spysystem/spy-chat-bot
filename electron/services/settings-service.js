...
var SettingsService = /** @class */ (function () {
    ...
    SettingsService.prototype.getUserName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var settings;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        settings = _a.sent();
                        return [2 /*return*/, settings.userName || null];
                }
            });
        });
    };
    SettingsService.prototype.saveUserName = function (userName) {
        return __awaiter(this, void 0, void 0, function () {
            var settings;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SettingsService.prototype.getAutoTldr = function () {
        return __awaiter(this, void 0, void 0, function () {
            var settings;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        settings = _a.sent();
                        return [2 /*return*/, settings.autoTldr || false];
                }
            });
        });
    };
    SettingsService.prototype.saveAutoTldr = function (autoTldr) {
        return __awaiter(this, void 0, void 0, function () {
            var settings;
            return __generator(this, function (_a) {
                switch (_a.label) {
